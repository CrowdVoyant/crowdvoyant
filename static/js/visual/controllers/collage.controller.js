...
(function () {
  ...
  .controller('CollageController', CollageController);

  CollageController.$inject = ['$location', '$scope', 'Visual', '$routeParams', '$mdDialog'];

  /**
  * @namespace ImageController
  */
  function CollageController($location, $scope, Visual, $routeParams, $mdDialog) {
    ...
    Visual.getMeme($routeParams.param).then(function(Data){
      self.meme = Data[0];
      console.log(self.meme);
      Visual.getStory(self.meme.story).then(function(Data){
        self.story = Data[0];
